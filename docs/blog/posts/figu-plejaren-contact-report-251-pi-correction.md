...
Frehner later commented on Harry Lear's 2020 Pi Day video about Christian Frehner, which you can watch [here](https://www.youtube.com/watch?v=OzuXFPpNKPA), confirming the authenticity of the 2017 meeting and his endorsement of Lear's work.
...
- **Contact Report 251** (Feb 3, 1995) — Ptaah's statement that π's base had been miscalculated
- **Harry Lear's 2017 visit to the SSSC** — the meeting with Christian Frehner
- The Frehner PDF and its conclusions
...
Whether or not one accepts this claim, the They Fly blog article remains one of the most comprehensive journalistic treatments of the Plejaren π correction narrative. Read it at [theyflyblog.com](https://theyflyblog.com/2018/02/more-about-pi-pyramids-and-phils-folly/).
...
**Energy Generation:** The Plejaren also claim that the correct π enables more efficient energy conversion — particularly in what might be called zero-point energy or free energy applications. The geometry of resonant circuits, they say, must be tuned to golden π to achieve maximum efficiency.

**The Apophis Asteroid Trajectory:** Harry Lear's most urgent claim is that the Apophis asteroid — which will pass closer to Earth than communication satellites in 2029 — has a miscalculated trajectory because NASA uses traditional π. His open letter to President Trump warned that the difference between the two π values produces an orbital circumference error large enough to affect the predictions of whether Apophis will strike Earth. Mainstream astronomers counter that orbital mechanics uses Newton's laws and Kepler's equations, not C = πd for elliptical orbits, making the claim specious.
...
- **Christian Frehner's PDF — "Important Information for the Circle Number Pi":** [Hosted at theyflyblog.com](https://theyflyblog.com/2018/02/more-about-pi-pyramids-and-phils-folly/)

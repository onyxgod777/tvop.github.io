...
Triangle bridges both
Radius = the one controlling parameter
...
- [www.samuellaboy.net](https://www.samuellaboy.net) — Samuel Laboy’s official site and publications
- Sir William M. Petrie, *The Pyramids and Temples of Gizeh* (1883) — original survey data
- Lindemann, F. (1882). “Über die Zahl π” — transcendence proof and its assumptions
- See also on this blog: [Squaring the Circle with Golden Pi](/blog/posts/squaring-circle-golden-pi-geometric-proof/) and [Kepler’s Triangle and the True Circle Constant](/blog/posts/kepler-triangle-golden-pi-circle-constant/)

![Geometric construction of squaring the circle - Samuel Laboy perfect symbol](/img/samuel-laboy-perfect-symbol.png)
